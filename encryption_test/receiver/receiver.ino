...
#define INPUT_BUFFER_LIMIT (163 + 1)
...
void loop() {
  ...
  delay(5);
  // Decrypt the message
  decryption(packetSize);

  String cleartext_str = String((char *)cleartext);
  Serial.println("Decrypted: ");
  Serial.println(cleartext_str);
  delay(10);
}

void readPackets(int packetSize) {
